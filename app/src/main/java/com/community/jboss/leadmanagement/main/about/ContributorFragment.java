...
import com.community.jboss.leadmanagement.data.models.ContributionModel;
import com.community.jboss.leadmanagement.utils.ContributorListAdapter;
import com.community.jboss.leadmanagement.utils.listeners.RecyclerTouchListener;
...
import static com.community.jboss.leadmanagement.main.about.AboutFragment.PREF_DARK_THEME;
...
public class ContributorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            String data = new ContributionCounter().execute("https://api.github.com/repos/JBossOutreach/lead-management-android/contributors").get();
